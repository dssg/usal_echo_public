...
def write_dicom_metadata_csv(df, metadata_file_suffix=None):    
    ...
    if metadata_file_suffix is None:
        ...
        dicom_meta_path = os.path.join(data_path,'dicom_metadata_'+str(metadata_file_suffix)+'.csv')
    ...
    print('dicom metadata saved for study {}, instance {}'.format(df.iloc[0,0], df.iloc[0,1]))
