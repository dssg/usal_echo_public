...
def segmentstudy(viewlist_a2c, viewlist_a4c, viewlist_psax, viewlist_plax, dicomdir):
    ...
    for video in viewlist_a4c:
        ...
        df = pd.DataFrame({instance_id_dict.get(video), 
                                   study_id_dict.get(video), 
                                   "a4c",
                                   np_arrays_x3,
                                   images_uuid_x3,
                                   datetime.now(),
                                   video}, columns=['prediction_id', 'instance_id', 'study_id', 'view_name', 'output_np', 'output_image', 'date_run', 'file_name'])
...
def main():
    ...
    viewfile = "/home/ubuntu/courtney/usal_echo/data/d04_segmentation/view_probabilities_test2019-08-06.txt"
