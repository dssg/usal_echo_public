...
def results_txt_to_db():
    ...
    f = text_files[
        2
    ]  # TO DO: soft-code this, i.e. don't always get first file in directory
    print(f)
    ...
    for pred in view23_pred:
        view4_pred.append(
            [key for key, element in maps_m1.items() if pred in element][0]
        )
    ...
    # io_views.save_to_db(corr_df, 'test1000_for_m1_dicomsample_probabilities_from_zhang_env')
    io_views.save_to_db(corr_df, "test1000_for_m1_dicomsample_probabilities")
